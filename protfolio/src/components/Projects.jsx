...
const Projects = () => {
    return (
        <section className='project-container'>
            <h2>Projetos</h2>
            <p>
                A maioria dos meus projetos estão restritos, pois trabalho em uma empresa pública federal e todos os meus projetos são desenvolvidos exclusivamente para esta instituição. Devido à natureza sensível e confidencial dos dados e operações, apenas pessoas internas têm acesso aos detalhes e ao funcionamento dessas iniciativas.
